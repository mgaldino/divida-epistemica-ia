...
\vfill{\tiny\color{muted}Movimento análogo ao de Sculley et al. (2015): a dívida de sistemas de ML é difícil de detectar porque existe no nível do sistema, e os remédios de nível de código não a alcançam. Aqui o mecanismo é cognitivo, não técnico.}
\end{frame}
